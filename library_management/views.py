...
from .models import Book, BookItem, BorrowRequest, BorrowRequestItem, UserFavorite
...
def create_borrow_request(request, book_id):
    ...
    if request.method == "POST":
        ...
        # redirect về lịch sử mượn của chính user
...
def borrow_history(request):
    ...
    return render(request, "library_management/borrow_history.html", context)
...
# ================================
# favourite: Trang sach yeu thich 
# ================================
@login_required
def favorite_books(request):
    ...
    return render(request, "library_management/favorites.html", context)
